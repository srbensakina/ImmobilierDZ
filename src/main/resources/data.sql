...
INSERT INTO house (id , name, description,occupied , photos, type, price, address_id, owner_id,number_of_floors) VALUES (5 ,'drgrsgse' , 'this is a house' , 'true', 'dzfrzetdtgd', 'RENT' , 10000 , 5 , 1,2 );
INSERT INTO house (id , name, description,occupied , photos, type, price, address_id, owner_id,number_of_floors) VALUES (6 ,'srgsegegh' , 'medim house2' , 'false', 'efzef', 'SALE' , 10240 ,6  , 3,1 );

--INSERT INTO flat (floor , number_of_rooms , id ) VALUES (5 ,3 , 2 );
--INSERT INTO flat (floor , number_of_rooms , id ) VALUES (1 ,1 , 4 );

INSERT INTO flat ( id,name, description,occupied , photos, type, price, address_id , owner_id ,floor , number_of_rooms ) VALUES (2 ,'rgegrg' , 'no no house' , 'true', 'dtdzefzetgd', 'RENT' , 10500 , 2 , 1,5, 3);
INSERT INTO flat ( id,name, description,occupied , photos, type, price, address_id , owner_id, floor , number_of_rooms) VALUES (4 ,'fgrzegdfg' , 'big big' , 'true', 'dtdezfezftgd', 'COLLOCATION' , 100450 , 4 , 3,1,1);
